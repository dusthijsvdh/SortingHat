...
# Our own views
from controllers import excel_controller, results_controller, vraag_controller
...
def vraag(vraagGetal, index):
    ...
    if request.method == "POST":
        ...
        if vraag_controller.handle_antwoorden(antwoorden, index, form) == 1:
